...
module Template = struct
  ...
  let get_loc = function
    ...
    | DataConstructor(loc, _) | ExceptionConstructor(loc, _) | VariantConstructor(loc, _, _) | ModSubscriptDataCon(_, loc, _, _) | App (loc, _, _) | Lambda (loc, _, _) | StringLit (loc, _) | NumLit (loc, _)
