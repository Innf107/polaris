...
expr:
  ...
  | LET REC IDENT LPAREN ident_list RPAREN EQUALS expr          { LetRecSeq ($3, $5, $8)}       // let rec f(x, .., x) = e
  | LET IDENT LPAREN ident_list RPAREN EQUALS expr IN expr      { Let ($2, Lambda($4, $7), $9)} // let f(x, .., x) = e in e
  | LET REC IDENT LPAREN ident_list RPAREN EQUALS expr IN expr  { LetRec ($3, $5, $8, $10)}     // let rec f(x, .., x) = e in e
  | LBRACE expr_semi_list RBRACE                            { Seq($2) }                         // {e; ..; e}
  | expr LPAREN expr_comma_list RPAREN                      { match $1 with 
                                                              | Var "print" -> Print(List.hd $3) (* print(e) *)
                                                              | _ -> App($1, $3) }              // e(e,..,e)
  ...
  | expr DOUBLEEQUALS expr                                  { Equals($1, $3) }                  // e = e
